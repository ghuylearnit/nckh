-- =============================================
-- Add Missing Student Data
-- Thêm dữ liệu cho các sinh viên còn thiếu
-- =============================================

USE sgu_student_management;

-- =============================================
-- Sinh viên 4: Lê Hoàng Cường (3122410003) - user_id = 4
-- Sinh viên trung bình
-- =============================================

-- HK1 2022
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(4, (SELECT id FROM course WHERE code='GE101'), 1, 'completed', 1),
(4, (SELECT id FROM course WHERE code='MA101'), 1, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS101'), 1, 'completed', 1);

INSERT INTO grade (enrollment_id, midterm_score, final_score, total_score, grade_letter, gpa_point, passed) VALUES
(LAST_INSERT_ID()-2, 6.5, 7.0, 6.8, 'C+', 2.5, TRUE),
(LAST_INSERT_ID()-1, 6.0, 6.5, 6.3, 'C+', 2.5, TRUE),
(LAST_INSERT_ID(), 7.0, 7.0, 7.0, 'B', 3.0, TRUE);

-- HK2 2022
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(4, (SELECT id FROM course WHERE code='GE102'), 2, 'completed', 1),
(4, (SELECT id FROM course WHERE code='MA102'), 2, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS102'), 2, 'completed', 1),
(4, (SELECT id FROM course WHERE code='MA103'), 2, 'completed', 1);

INSERT INTO grade (enrollment_id, midterm_score, final_score, total_score, grade_letter, gpa_point, passed) VALUES
(LAST_INSERT_ID()-3, 6.5, 7.0, 6.8, 'C+', 2.5, TRUE),
(LAST_INSERT_ID()-2, 6.0, 6.5, 6.3, 'C+', 2.5, TRUE),
(LAST_INSERT_ID()-1, 7.0, 7.5, 7.3, 'B', 3.0, TRUE),
(LAST_INSERT_ID(), 6.5, 6.5, 6.5, 'C+', 2.5, TRUE);

-- HK1 2023
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(4, (SELECT id FROM course WHERE code='GE103'), 3, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS103'), 3, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS104'), 3, 'completed', 1),
(4, (SELECT id FROM course WHERE code='MA104'), 3, 'completed', 1);

INSERT INTO grade (enrollment_id, midterm_score, final_score, total_score, grade_letter, gpa_point, passed) VALUES
(LAST_INSERT_ID()-3, 7.0, 7.0, 7.0, 'B', 3.0, TRUE),
(LAST_INSERT_ID()-2, 6.5, 7.0, 6.8, 'C+', 2.5, TRUE),
(LAST_INSERT_ID()-1, 7.0, 7.5, 7.3, 'B', 3.0, TRUE),
(LAST_INSERT_ID(), 6.5, 7.0, 6.8, 'C+', 2.5, TRUE);

-- HK2 2023
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(4, (SELECT id FROM course WHERE code='GE104'), 4, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS105'), 4, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS106'), 4, 'completed', 1);

INSERT INTO grade (enrollment_id, midterm_score, final_score, total_score, grade_letter, gpa_point, passed) VALUES
(LAST_INSERT_ID()-2, 7.0, 7.0, 7.0, 'B', 3.0, TRUE),
(LAST_INSERT_ID()-1, 6.5, 7.0, 6.8, 'C+', 2.5, TRUE),
(LAST_INSERT_ID(), 7.0, 7.5, 7.3, 'B', 3.0, TRUE);

-- HK1 2024
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(4, (SELECT id FROM course WHERE code='GE105'), 5, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS107'), 5, 'completed', 1),
(4, (SELECT id FROM course WHERE code='CS109'), 5, 'completed', 1);
...
-- HK2 2024 (đang học)
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(4, (SELECT id FROM course WHERE code='CS108'), 6, 'enrolled', 1),
(4, (SELECT id FROM course WHERE code='CS110'), 6, 'enrolled', 1);

-- Chứng chỉ
INSERT INTO student_certificate (user_id, certificate_type, certificate_name, score_or_level, issue_date, verified) VALUES
(4, 'english', 'TOEIC', '500', '2024-01-10', TRUE),
(4, 'it', 'MOS', 'Pass', '2023-11-15', TRUE),
(4, 'physical_education', 'GDTC', 'Pass', '2024-01-20', TRUE),
(4, 'defense_education', 'GDQP', 'Pass', '2023-06-15', TRUE);
...
-- HK2 2024 (đang học)
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(5, (SELECT id FROM course WHERE code='CS108'), 6, 'enrolled', 1),
(5, (SELECT id FROM course WHERE code='CS110'), 6, 'enrolled', 1);
...
-- =============================================
-- Sinh viên 7: Phạm Thị Phương (3122410006) - user_id = 7
-- Sinh viên khá
-- =============================================
...
-- HK2 2024 (đang học)
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(7, (SELECT id FROM course WHERE code='CS108'), 6, 'enrolled', 1),
(7, (SELECT id FROM course WHERE code='CS110'), 6, 'enrolled', 1);
...
-- HK2 2024 (đang học)
INSERT INTO enrollment (user_id, course_id, term_id, status, attempt_number) VALUES
(8, (SELECT id FROM course WHERE code='CS108'), 6, 'enrolled', 1),
(8, (SELECT id FROM course WHERE code='CS110'), 6, 'enrolled', 1);
...
-- Check total enrollments and grades
SELECT 
    u.id,
    u.name,
    u.student_code,
